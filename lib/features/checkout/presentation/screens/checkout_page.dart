...
import '../widgets/delivry_time_widget.dart';
            ...
            child: CustomScrollView(
              slivers: [
                SliverToBoxAdapter(
                  child: Column(
                    children: [
                      CustomTitleText(sizeTxt: 15.sp, title: "Address"),
                      LocationWidget(),
                      CustomTitleText(sizeTxt: 15.sp, title: "Delivery time"),
                      DeliveryTimeWidget(),
                      CustomTitleText(sizeTxt: 15.sp, title: "Payment Method"),
                      PaymentMethodWidget(),
                      CustomTitleText(sizeTxt: 15.sp, title: "Payment"),
                      SubTotalWidget(),
                      SizedBox(height: 10.h),
                      CustomButton(
                        data: "Place Order",
