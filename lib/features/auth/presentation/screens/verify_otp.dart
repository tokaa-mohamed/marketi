...
class VerifyOtpScreen extends StatefulWidget {
  ...
  const VerifyOtpScreen({super.key, this.targetDestination});

  @override
  State<VerifyOtpScreen> createState() => _VerifyOtpViewState();
}

class _VerifyOtpViewState extends State<VerifyOtpScreen> {
