...
prefixIcon: Assets.icons.passwordIcon.path,
                    ...
                    Center(
                      child: Text(
                        'Or Continue With',
                        style: getRegularStyle(fontSize: AppFonts.s12.sp,height: 2.h, color: AppColors.navy),
                      ),
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Text(
                            'register?',
                            style: getBoldStyle(fontSize: AppFonts.s12.sp, color: AppColors.primaryColor),
                          ),
                        ),
                      ],
                    ),
